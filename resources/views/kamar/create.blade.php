...
<div class="container">
    ...
    <form action="{{ route('kamar.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tipe_kamar" class="form-control" value="{{ old('tipe_kamar') }}" required>
            @error('tipe_kamar') 
                <small class="text-danger">{{ $message }}</small> 
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="harga_per_malam" class="form-control" value="{{ old('harga_per_malam') }}" step="0.01" required>
